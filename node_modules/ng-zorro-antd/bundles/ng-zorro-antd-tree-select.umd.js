    ...
    ***************************************************************************** */
    ...
    var NzTreeSelectComponent = /** @class */ (function () {
        function NzTreeSelectComponent(renderer, cdr, nzTreeService, elementRef, noAnimation) {
            ...
            this.nzCleared = new core.EventEmitter();
            this.nzRemoved = new core.EventEmitter();
            this.nzExpandChange = new core.EventEmitter();
            this.nzTreeClick = new core.EventEmitter();
            this.nzTreeCheckBoxChange = new core.EventEmitter();
            ...
            function (init) {
                ...
                if (init) {
                    ...
                    if (!this.nzTreeService.isArrayOfNzTreeNode(this.nzNodes)) {
                         ...
                         * @param {?} item
                         * @return {?}
                         */function (item) { return new core$1.NzTreeNode(item, undefined, _this.nzTreeService); }));
                    }
                    else {
                        nodes = this.nzNodes.map(( /**
                         * @param {?} item
                         * @return {?}
                         */function (item) { return new core$1.NzTreeNode(__assign({}, item.origin), undefined, _this.nzTreeService); }));
                    }
