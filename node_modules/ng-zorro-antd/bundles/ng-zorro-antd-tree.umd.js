    ...
    ***************************************************************************** */
    ...
    var NzTreeComponent = /** @class */ (function () {
        function NzTreeComponent(nzTreeService, cdr, noAnimation) {
            ...
            // model bind
            this.nzExpandedKeysChange = new core.EventEmitter();
            this.nzSelectedKeysChange = new core.EventEmitter();
            this.nzCheckedKeysChange = new core.EventEmitter();
            this.nzSearchValueChange = new core.EventEmitter();
            /**
             * @deprecated use
             * nzSearchValueChange instead
             */
            this.nzOnSearchNode = new core.EventEmitter();
            ...
            function (value) {
                ...
                if (Array.isArray(value)) {
                    if (!this.nzTreeService.isArrayOfNzTreeNode(value)) {
                         ...
                         * @param {?} item
                         * @return {?}
                         */function (item) { return new core$1.NzTreeNode(item, null, _this.nzTreeService); }));
                    }
                    else {
                        nzNodes = value.map(( /**
                         * @param {?} item
        ...
        NzTreeComponent.propDecorators = {
            ...
            nzTreeTemplate: [{ type: core.ContentChild, args: ['nzTreeTemplate',] }]
        };
        __decorate([
            core$1.InputBoolean(),
            __metadata("design:type", Object)
