...
import { Injectable, forwardRef, ChangeDetectorRef, Component, ElementRef, EventEmitter, Host, Injector, Input, Optional, Output, Renderer2, Self, ViewChild, NgModule } from '@angular/core';
import { NG_VALUE_ACCESSOR, FormsModule } from '@angular/forms';
import { NzTreeBaseService, isNotNil, slideMotion, zoomMotion, InputBoolean, NzNoAnimationDirective, NzTreeHigherOrderServiceToken, NzTreeNode, NzNoAnimationModule, NzOverlayModule } from 'ng-zorro-antd/core';
    ...
    function (init) {
        ...
        if (init) {
            ...
            if (!this.nzTreeService.isArrayOfNzTreeNode(this.nzNodes)) {
                 ...
                 * @return {?}
                 */
                function (item) { return new NzTreeNode(__assign({}, item.origin), undefined, _this.nzTreeService); }));
            }
